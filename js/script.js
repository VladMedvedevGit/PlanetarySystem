	...
	renderPlanet(index){
		return `<div class="accordion-item">
			<h2 class="accordion-header" id="heading${this.name.replace(' ','')}">
				  ...
				  <img class="accordion-button_img" src="./images/${this.name.replace(' ','')}.svg" width="25" height="25">	
				  ${this.name}
			  	</button>
			</h2>
			<div id="collapse${this.name.replace(' ','')}" class="accordion-collapse collapse ${index !=0 ? '' : 'show'}" aria-labelledby="heading${this.name.replace(' ','')}" data-bs-parent="#accordionPlanetarySystem">
